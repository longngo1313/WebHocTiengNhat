...
<ul class="nav nav-tabs" style="margin-left:250px;padding-bottom: 10px">
    <li role="presentation" >
    	...
    	<a href="index" class="label label-success">Home</a></li>
    ...
    <ul class="nav navbar-nav"style="margin-left:640px;">
                            <form class="form-inline" method="post" action="checkWord.jsp">


                  
                                 <input class="input_tex form-control" type="text" type="text" id="key" placeholder="Kanji hoặc Hiragana " name="key" />                                
                                 <button type="Submit"  class="btn btn-danger navbar-btn" value="Search" />Tra từ</button>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail">
                        <img src="img/n4.png" alt=""><span class="border-0"></span>
